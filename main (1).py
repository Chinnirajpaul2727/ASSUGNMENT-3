...
plt.scatter(data['GDP_Per_Capita'], data['CO2_Per_Head'], c=data['Cluster'], cmap='viridis', label='Clusters')
...
plt.plot(future_years, predicted_values, label='Best Fitting Function', color='green')
plt.fill_between(future_years, lower_bound, upper_bound, color='green', alpha=0.3, label='Confidence Range')
plt.xlabel('Year')
